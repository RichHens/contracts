 ...
 * ------------------------------------------------------------------------------
 */
describe('HEG Vesting: Revocation vesting access tests', function () {
    ...
    describe('Request tests', function () {
        ...
        it("not enough approvals (approvals == minApprovalsRequired - 1)", async function() {
            ...
            await revokeFailed(admin1, testScheduleId, "HEGVesting: Not enough approves.");
        });
        ...
        it("try to create a request twice", async function() {
            ...
            await requestRevocationFailed(admin1, testScheduleId, "HEGVesting: Revocation is already requested.");
        });
        ...
        it("try to revoke a non-revocable schedule", async function() {
            await requestRevocationFailed(
                ...
                "HEGVesting: Schedule is not revocable."
            );
        });
        ...
        it("try to revoke a non-existent request", async function() {
            await requestRevocationFailed(
                ...
                "HEGVesting: Schedule does not exist."
            );
        });
        ...
        it("try to revoke a non-created request", async function() {
            ...
            await requestRevocationFailed(
                admin1,
                await vesting.generateScheduleId(notAdmin.address, 1),
                "HEGVesting: Schedule is not created."
            );
        });
    });
    ...
    describe('Revocation tests', function () {
        ...
        it("try to revoke already revoked request", async function() {
            ...
            await revokeSuccess(admin1, testScheduleId);
            await revokeFailed(admin1, testScheduleId, "HEGVesting: Schedule does not exist.")
        });
    });
    ...
    describe('onlyAdmin tests', function () {
        ...
        it("revoke", async function() {
            await revokeFailed(notAdmin, testScheduleId, "HEGVesting: You are not an admin.");
        });

        // ----------------------------------------------------------------------------
        it("requestRevocation", async function() {
            await requestRevocationFailed(notAdmin, testScheduleId, "HEGVesting: You are not an admin.");
        });

        // ----------------------------------------------------------------------------
        it("revokeRevocationRequest", async function() {
            await revokeRevocationRequestFailed(notAdmin, testScheduleId, "HEGVesting: You are not an admin.");
        });
    });
